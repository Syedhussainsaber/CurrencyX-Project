...
export const metadata = {
  title: 'Global CurrencyX Blog — FX Research & Platform Updates',
  description: 'Read thought leadership on currency markets, compliance, and platform releases from the CurrencyX team.'
}
        ...
        <section className="py-16 md:py-24 text-center">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
            ...
            <p className="text-lg text-muted-foreground">
              Weekly FX signals, product launches, and compliance guidance curated by CurrencyX researchers.
            </p>
          </div>
        </section>
