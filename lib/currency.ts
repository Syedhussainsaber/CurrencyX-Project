...
const getMockRates = (base: string): CurrencyRatesPayload => {
  ...
  const usdRates: Record<string, number> = {
    ...
    KRW: 1320, MOP: 8.05, BND: 1.35, KHR: 4100, LAK: 21000, MMK: 2100, NPR: 133,
    ...
    MZN: 64.0, AOA: 830, CDF: 2800, RWF: 1200, BIF: 2850, DJF: 178, ERN: 15.0,
    SOS: 570, SSP: 1300, SDG: 600, EGP: 31.0, LYD: 4.85, TND: 3.1, DZD: 134,
    MAD: 10.0, MRU: 40.0, XOF: 600, XAF: 600, GNF: 8600, SLL: 22000, LRD: 190,
